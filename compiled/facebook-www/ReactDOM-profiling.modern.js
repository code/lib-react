...
for (
  var i$jscomp$inline_2157 = 0;
  i$jscomp$inline_2157 < simpleEventPluginEvents.length;
  i$jscomp$inline_2157++
) {
  var eventName$jscomp$inline_2158 =
      simpleEventPluginEvents[i$jscomp$inline_2157],
    domEventName$jscomp$inline_2159 =
      eventName$jscomp$inline_2158.toLowerCase(),
    capitalizedEvent$jscomp$inline_2160 =
      eventName$jscomp$inline_2158[0].toUpperCase() +
      eventName$jscomp$inline_2158.slice(1);
  registerSimpleEvent(
    domEventName$jscomp$inline_2159,
    "on" + capitalizedEvent$jscomp$inline_2160
  );
}
  ...
  switch (type) {
    ...
    case "link":
      if (
        ...
        var styles$336 = getResourcesFromRoot(
            JSCompiler_inline_result
          ).hoistableStyles,
          resource$337 = styles$336.get(type);
        resource$337 ||
          ((JSCompiler_inline_result =
          ...
          styles$336.set(type, resource$337),
          (styles$336 = JSCompiler_inline_result.querySelector(
            getStylesheetSelectorFromKey(type)
          ))
            ? styles$336._p ||
              ((resource$337.instance = styles$336),
              (resource$337.state.loading = 5))
            : ((styles$336 = preloadPropsMap.get(type)),
              styles$336 ||
                ((styles$336 = {
                  rel: "preload",
                  as: "style",
                ...
                preloadPropsMap.set(type, styles$336)),
              preloadStylesheet(
                JSCompiler_inline_result,
                type,
                styles$336,
  ...
  if (null === resource.instance)
    switch (resource.type) {
      ...
      case "stylesheet":
        ...
        var instance$342 = hoistableRoot.querySelector(
          getStylesheetSelectorFromKey(styleProps)
        );
        if (instance$342)
          return (
            (resource.state.loading |= 4),
            (resource.instance = instance$342),
            markNodeAsHoistable(instance$342),
            instance$342
          );
        ...
        markNodeAsHoistable(instance$342);
        var linkInstance = instance$342;
        linkInstance._p = new Promise(function (resolve, reject) {
          linkInstance.onload = resolve;
          linkInstance.onerror = reject;
        });
        setInitialProperties(instance$342, "link", instance);
        resource.state.loading |= 4;
        insertStylesheet(instance$342, props.precedence, hoistableRoot);
        return (resource.instance = instance$342);
      case "script":
        instance$342 = getScriptKey(props.src);
        if (
          (styleProps = hoistableRoot.querySelector(
            getScriptSelectorFromKey(instance$342)
          ))
        )
          return (
        ...
        instance = props;
        if ((styleProps = preloadPropsMap.get(instance$342)))
...
if (
  "19.3.0-www-modern-f598ec1c-20260716" !==
...
var internals$jscomp$inline_2394 = {
  bundleType: 0,
  version: "19.3.0-www-modern-f598ec1c-20260716",
  rendererPackageName: "react-dom",
  currentDispatcherRef: ReactSharedInternals,
  reconcilerVersion: "19.3.0-www-modern-f598ec1c-20260716"
};
enableSchedulingProfiler &&
...
exports.version = "19.3.0-www-modern-f598ec1c-20260716";
"undefined" !== typeof __REACT_DEVTOOLS_GLOBAL_HOOK__ &&
  "function" ===
