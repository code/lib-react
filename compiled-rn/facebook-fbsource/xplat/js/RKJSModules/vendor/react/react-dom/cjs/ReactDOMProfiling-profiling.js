 ...
 * @nolint
 * @preventMunge
 * @generated SignedSource<<3a849a972f7ea9d495a41600c98bf927>>
 */
      ...
      if (
        ...
        resource$330 ||
          ...
          (styles$329 = JSCompiler_inline_result.querySelector(
            ...
            : ((styles$329 = preloadPropsMap.get(type)),
              styles$329 ||
                ((styles$329 = {
                  rel: "preload",
                  as: "style",
                ...
                preloadPropsMap.set(type, styles$329)),
              preloadStylesheet(
                JSCompiler_inline_result,
                type,
                styles$329,
...
var isomorphicReactPackageVersion$jscomp$inline_2492 = React.version;
if (
  "19.3.0-native-fb-bfb7a768-20260811" !==
  isomorphicReactPackageVersion$jscomp$inline_2492
)
  throw Error(
    formatProdErrorMessage(
      527,
...
var internals$jscomp$inline_2499 = {
  bundleType: 0,
  ...
  getLaneLabelMap: function () {
    for (
      var map = new Map(), lane = 1, index$352 = 0;
      31 > index$352;
      index$352++
    ) {
...
if ("undefined" !== typeof __REACT_DEVTOOLS_GLOBAL_HOOK__) {
  var hook$jscomp$inline_3085 = __REACT_DEVTOOLS_GLOBAL_HOOK__;
  if (
    !hook$jscomp$inline_3085.isDisabled &&
    hook$jscomp$inline_3085.supportsFiber
  )
    try {
      (rendererID = hook$jscomp$inline_3085.inject(
        internals$jscomp$inline_2499
      )),
        (injectedHook = hook$jscomp$inline_3085);
    } catch (err) {}
}
