 ...
 * @nolint
 * @preventMunge
 * @generated SignedSource<<4e131793713b0df25fb5b5ced78b0c47>>
 */
...
var isomorphicReactPackageVersion$jscomp$inline_2268 = React.version;
if (
  "19.2.0-native-fb-8dba9311-20250815" !==
  isomorphicReactPackageVersion$jscomp$inline_2268
)
  throw Error(
    formatProdErrorMessage(
      527,
...
if ("undefined" !== typeof __REACT_DEVTOOLS_GLOBAL_HOOK__) {
  var hook$jscomp$inline_2800 = __REACT_DEVTOOLS_GLOBAL_HOOK__;
  if (
    !hook$jscomp$inline_2800.isDisabled &&
    hook$jscomp$inline_2800.supportsFiber
  )
    try {
      (rendererID = hook$jscomp$inline_2800.inject(
        internals$jscomp$inline_2275
      )),
        (injectedHook = hook$jscomp$inline_2800);
    } catch (err) {}
}
