 ...
 * @nolint
 * @preventMunge
 * @generated SignedSource<<59c402167f7e776d30631e5d1c374ebd>>
 */
    ...
    if (0 !== (completedWork.mode & 2)) {
      for (
        ...
        (newChildLanes |= child$126.lanes | child$126.childLanes),
          (subtreeFlags |= child$126.subtreeFlags & 132120576),
          (subtreeFlags |= child$126.flags & 132120576),
      ...
      for (
        ...
        (newChildLanes |=
          ...
          (subtreeFlags |= treeBaseDuration$125.subtreeFlags & 132120576),
          (subtreeFlags |= treeBaseDuration$125.flags & 132120576),
  ...
  switch (finishedWork.tag) {
    ...
    case 22:
      ...
      var prevOffscreenSubtreeIsHidden = offscreenSubtreeIsHidden,
        ...
        prevOffscreenDirectParentIsHidden$188 = offscreenDirectParentIsHidden;
      offscreenSubtreeIsHidden = prevOffscreenSubtreeIsHidden || hoistableRoot;
      offscreenDirectParentIsHidden =
        prevOffscreenDirectParentIsHidden$188 || hoistableRoot;
      offscreenSubtreeWasHidden = prevOffscreenSubtreeWasHidden || i;
      recursivelyTraverseMutationEffects(root, finishedWork, lanes);
      offscreenSubtreeWasHidden = prevOffscreenSubtreeWasHidden;
      offscreenDirectParentIsHidden = prevOffscreenDirectParentIsHidden$188;
...
for (
  var i$jscomp$inline_1950 = 0;
  i$jscomp$inline_1950 < simpleEventPluginEvents.length;
  i$jscomp$inline_1950++
) {
  var eventName$jscomp$inline_1951 =
      simpleEventPluginEvents[i$jscomp$inline_1950],
    domEventName$jscomp$inline_1952 =
      eventName$jscomp$inline_1951.toLowerCase(),
    capitalizedEvent$jscomp$inline_1953 =
      eventName$jscomp$inline_1951[0].toUpperCase() +
      eventName$jscomp$inline_1951.slice(1);
  registerSimpleEvent(
    domEventName$jscomp$inline_1952,
    "on" + capitalizedEvent$jscomp$inline_1953
  );
}
      ...
      for (lastDefaultValue in nextProps)
        if (
          ...
          switch (lastDefaultValue) {
            case "selected":
              propKey$257 !== propKey && (rootMutationContext = !0);
              domElement.selected =
                propKey$257 &&
...
if (
  "19.3.0-native-fb-be48396d-20251110" !==
...
if ("undefined" !== typeof __REACT_DEVTOOLS_GLOBAL_HOOK__) {
  var hook$jscomp$inline_2986 = __REACT_DEVTOOLS_GLOBAL_HOOK__;
  if (
    !hook$jscomp$inline_2986.isDisabled &&
    hook$jscomp$inline_2986.supportsFiber
  )
    try {
      (rendererID = hook$jscomp$inline_2986.inject(
        internals$jscomp$inline_2374
      )),
        (injectedHook = hook$jscomp$inline_2986);
    } catch (err) {}
}
...
exports.version = "19.3.0-native-fb-be48396d-20251110";
