 ...
 * @nolint
 * @preventMunge
 * @generated SignedSource<<30781be72225d899857132f5bfd23cd7>>
 */
...
var isomorphicReactPackageVersion$jscomp$inline_2267 = React.version;
if (
  "19.2.0-native-fb-8dba9311-20250815" !==
  isomorphicReactPackageVersion$jscomp$inline_2267
)
  throw Error(
    formatProdErrorMessage(
      527,
...
if ("undefined" !== typeof __REACT_DEVTOOLS_GLOBAL_HOOK__) {
  var hook$jscomp$inline_2797 = __REACT_DEVTOOLS_GLOBAL_HOOK__;
  if (
    !hook$jscomp$inline_2797.isDisabled &&
    hook$jscomp$inline_2797.supportsFiber
  )
    try {
      (rendererID = hook$jscomp$inline_2797.inject(
        internals$jscomp$inline_2274
      )),
        (injectedHook = hook$jscomp$inline_2797);
    } catch (err) {}
}
