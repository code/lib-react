 ...
 * @nolint
 * @preventMunge
 * @generated SignedSource<<0e18b4997b93b3ed4e87a1779827b163>>
 */
...
function bubbleProperties(completedWork) {
  ...
  if (didBailout)
    if (0 !== (completedWork.mode & 2)) {
      for (
        var treeBaseDuration$89 = completedWork.selfBaseDuration,
          child$90 = completedWork.child;
        null !== child$90;
      ...
      for (
        treeBaseDuration$89 = completedWork.child;
        null !== treeBaseDuration$89;
    ...
    for (var child = completedWork.child; null !== child; )
      (newChildLanes |= child.lanes | child.childLanes),
        ...
        (treeBaseDuration$89 += child.actualDuration),
        (child$90 += child.treeBaseDuration),
        (child = child.sibling);
    completedWork.actualDuration = treeBaseDuration$89;
    completedWork.treeBaseDuration = child$90;
  } else
    for (
      treeBaseDuration$89 = completedWork.child;
      null !== treeBaseDuration$89;
      ...
      (newChildLanes |=
        treeBaseDuration$89.lanes | treeBaseDuration$89.childLanes),
        (subtreeFlags |= treeBaseDuration$89.subtreeFlags),
        (subtreeFlags |= treeBaseDuration$89.flags),
        (treeBaseDuration$89.return = completedWork),
        (treeBaseDuration$89 = treeBaseDuration$89.sibling);
...
function prepareFreshStack(root, lanes) {
    ...
    if (0 !== (lanes & 127)) {
      ...
      endTime =
        0 <= blockingEventTime && blockingEventTime < blockingClampTime
          ? blockingClampTime
          : blockingEventTime;
      var clampedRenderStartTime$156 =
        0 <= endTime
          ? endTime
      ...
      0 <= blockingSuspendedTime &&
        ...
        logSuspendedWithDelayPhase(
          ...
          clampedRenderStartTime$156,
          lanes
        ));
      clampedRenderStartTime$156 = blockingEventType;
      ...
      supportsUserTiming &&
        ...
        0 < endTime
          ? endTime > previousRenderStartTime &&
            (endTime = previousRenderStartTime)
          : (endTime = previousRenderStartTime),
        null !== clampedRenderStartTime$156 &&
          previousRenderStartTime > endTime &&
          console.timeStamp(
            eventIsRepeat
              ? "Consecutive"
              : "Event: " + clampedRenderStartTime$156,
            endTime,
            previousRenderStartTime,
            currentTrack,
            "Scheduler \u269b",
    ...
    0 !== (lanes & 4194048) &&
      ...
      supportsUserTiming &&
        ...
        0 < previousRenderStartTime
          ...
          : (previousRenderStartTime = endTime),
        0 < clampedRenderStartTime$156
          ? clampedRenderStartTime$156 > previousRenderStartTime &&
            (clampedRenderStartTime$156 = previousRenderStartTime)
          : (clampedRenderStartTime$156 = previousRenderStartTime),
        previousRenderStartTime > clampedRenderStartTime$156 &&
          null !== eventIsRepeat &&
          console.timeStamp(
  ...
  if (0 !== endTime)
    for (root = root.entanglements, endTime &= lanes; 0 < endTime; )
      (clampedRenderStartTime$156 = 31 - clz32(endTime)),
        (eventIsRepeat = 1 << clampedRenderStartTime$156),
        (lanes |= root[clampedRenderStartTime$156]),
...
var roots = new Map(),
  internals$jscomp$inline_1592 = {
    bundleType: 0,
    version: "19.3.0-native-fb-1ea46df8-20251111",
    rendererPackageName: "react-native-renderer",
    currentDispatcherRef: ReactSharedInternals,
    reconcilerVersion: "19.3.0-native-fb-1ea46df8-20251111"
  };
null !== extraDevToolsConfig &&
  (internals$jscomp$inline_1592.rendererConfig = extraDevToolsConfig);
internals$jscomp$inline_1592.getLaneLabelMap = function () {
  for (
...
internals$jscomp$inline_1592.injectProfilingHooks = function (profilingHooks) {
  injectedProfilingHooks = profilingHooks;
};
if ("undefined" !== typeof __REACT_DEVTOOLS_GLOBAL_HOOK__) {
  var hook$jscomp$inline_1946 = __REACT_DEVTOOLS_GLOBAL_HOOK__;
  if (
    !hook$jscomp$inline_1946.isDisabled &&
    hook$jscomp$inline_1946.supportsFiber
  )
    try {
      (rendererID = hook$jscomp$inline_1946.inject(
        internals$jscomp$inline_1592
      )),
        (injectedHook = hook$jscomp$inline_1946);
    } catch (err) {}
}
